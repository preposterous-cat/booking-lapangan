  ...
  return (
    <main className="flex min-h-screen px-16 py-10 bg-gray-100 justify-center">
      <div className="flex flex-col gap-10 w-full">
        ...
        <div className=" bg-white p-5 flex justify-between w-full">
          <h5 className="font-bold">Selesaikan pesanan dalam</h5>
          <p>
            <span className="p-1 bg-orange-400 text-white rounded-lg">02</span>
            <span className="p-1  text-orange-400">:</span>
            <span className="p-1 bg-orange-400 text-white rounded-lg">00</span>
            <span className="p-1  text-orange-400">:</span>
            <span className="p-1 bg-orange-400 text-white rounded-lg">02</span>
          </p>
        </div>
        ...
        <div className=" bg-white p-5 w-full">
          <h5 className="">Total Pembayaran</h5>
          <div className=" flex justify-between">
            <h3 className="font-bold text-xl">IDR 1.015.000</h3>
            <p className=" bg-orange-50 text-orange-400 rounded-full p-2">
              *Silahkan datang ke kantor dispora untuk membayar
            </p>
          </div>
        </div>
      </div>
